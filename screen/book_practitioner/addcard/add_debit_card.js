  ...
  render() {
    return (
      <View style={{flex:1 }}>
            ...
            {this.state.fontLoaded ? (  <Text style={styles.T2}>Card Number</Text>) : null }
      {this.state.fontLoaded ? (   <TextInput style={styles.T1}
        placeholder={'Card Number'}
        ></TextInput>) : null }


{this.state.fontLoaded ? (  <Text style={styles.T2}>Expiry date</Text>) : null }
      {this.state.fontLoaded ? (   <TextInput style={styles.T1}
...
{this.state.fontLoaded ? (  <Text style={styles.T2}>CVV</Text>) : null }
      {this.state.fontLoaded ? (   <TextInput style={styles.T1}
        placeholder={'3 character on the back of the card'}
        ></TextInput>) : null }

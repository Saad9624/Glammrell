  ...
  render() {
    return (
      <View>
                               ...
                               <View style={{ flexDirection: 'row', backgroundColor:'#ffffff' ,height:60 , justifyContent:'space-between' , alignContent:'center' }}>
                                                     ...
                                                     <TouchableOpacity 
                                                        onPress={() => this.props.navigation.goBack()} >
                                                           ...
                                                           <Text style={{fontSize:20  , alignSelf:'center' }}>Edit Address</Text>   
        ...
        <TouchableOpacity style={{width:'80%' , height:40 , borderColor:'#FF4D56' , marginTop:10 ,
         borderWidth:1 , alignSelf:'center' , backgroundColor:'#FF4D56' , borderRadius:20 }}> 
        <Text style={{alignSelf:'center' , marginTop:8 , color:'white'}}>Delete Address</Text>
        </TouchableOpacity>
